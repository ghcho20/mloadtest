...
def fillup_collection(coll_name):
    ...
    try:
        ...
        total_size_gb = float(DEFAULTS['SCAN_COLL_FILLSZ_GB'])
        NUM_THREADS = 4  # Number of threads to use for generating documents
        ...
        for i in range(1, NUM_THREADS+1):
            thread = threading.Thread(target=worker, args=(i, total_size_gb/NUM_THREADS, 512, 5_000))
...
if __name__ == "__main__":
    coll_name = DEFAULTS['COLLECTION_SCAN']
